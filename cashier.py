...
import validation as valid, takeorder, show, logins
...
class Cashier(tk.Tk):
    ...
    def __init__(self, empid, cur,*args, **kwargs):
        ...
        res = res[0][0].split()[0]
        title = "CASHIER - "+res.upper()
        self.title(title)
        for F in (MainMenu,CustomerDetails):
        
            frame = F(container, self)
            self.frames[F] = frame
            frame.grid(row = 0, column = 0, sticky = "nswe")
            
        for F in (Menu, ViewProfile, EditProfile, ChangePassword, SinglePizza, OrderCustomer, DetailsCustomer):
    ...
    def refresh(self):
        self.destroy()
        startCashier(self.empid, self.cur)
...
class MainMenu(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        but2 = tk.Button(self, text = "MENU", command = lambda : controller.show_frame(Menu), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but2.grid(row = 3,columnspan = 2, padx = 10, pady = 10, sticky = "we")
        
        but3 = tk.Button(self, text = "CUSTOMER DETAILS", command = lambda : controller.show_frame(CustomerDetails), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but3.grid(row = 4,columnspan = 2, padx = 10, pady = 10, sticky = "we")
        
        but4 = tk.Button(self, text = "CHANGE PASSWORD", command = lambda : controller.show_frame(ChangePassword), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but4.grid(row = 5,columnspan = 2, padx = 10, pady = 10, sticky = "we")
        
        but5 = tk.Button(self, text = "EDIT PROFILE", command = lambda : controller.show_frame(EditProfile), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but5.grid(row = 6,column = 0, padx = 15, pady = 15, sticky = "we")
        
        but6 = tk.Button(self, text = "VIEW PROFILE", command = lambda : controller.show_frame(ViewProfile), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but6.grid(row = 6,column = 1, padx = 15, pady = 15, sticky = "we")
        
        but10 = tk.Button(self, text = "EXIT", command = controller.exit,fg = "white", bg = "red", font = ("arial black",12,"bold"))
        but10.grid(row = 7,column = 0, padx = 10, pady = 10, sticky = "we")
        
        but11 = tk.Button(self, text = "LOGOUT", command = controller.logout,fg = "white", bg = "red", font = ("arial black",12,"bold"))
        but11.grid(row = 7,column = 1, padx = 10, pady = 10, sticky = "we")
...
class Menu(tk.Frame):
    ...
    def __init__(self,empid, cur, parent, controller):
        ...
        but3 = tk.Button(self, text = "BACK", command = lambda : controller.show_frame(MainMenu),fg = "white", bg = "red", font = ("arial black",12,"bold"))
...
class CustomerDetails(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        but1 = tk.Button(self, text = "ORDER OF CUSTOMER", command = lambda : controller.show_frame(OrderCustomer), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but1.grid(row = 1,columnspan = 2, padx = 10, pady = 10,sticky = "we")
        
        but2 = tk.Button(self, text = "DETAILS OF CUSTOMER", command = lambda : controller.show_frame(DetailsCustomer), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but2.grid(row = 2,columnspan = 2, padx = 10, pady = 10, sticky = "we")
...
def startCashier(empid, cur): 
    Cashier(empid,cur).mainloop()       
