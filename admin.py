...
import validation as valid, show, changes, creates, logins, takeorder
import time
...
class Admin(tk.Tk):
    ...
    def __init__(self, empid, cur,*args, **kwargs):
        ...
        for F in (ViewMenu, ViewProfile, EditProfile, ChangePassword,SinglePizza, ChangeMenu, Menu, ApplyOffers, ViewEmployeeDetails, ChangeEmployeeDetails, Sales, OrderCustomer, DetailsCustomer, HireFireRehire):
    ...
    def refresh(self):
        self.destroy()
        startAdmin(self.empid, self.cur)
    ...
    def back(self,par):
        ...
        elif par == "HireFireRehire":
            self.show_frame(HireFireRehire)
        elif par == "ViewMenu":
...
class Menu(tk.Frame):
    ...
    def __init__(self, empid, cur,parent, controller):
        ...
        but8 = tk.Button(self, text = "DELETE PIZZA", command = self.deletePizza, fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but8.grid(row = 6,columnspan = 2, padx = 10, pady = 10, sticky = "we")
        
        but6 = tk.Button(self, text = "BACK", command = controller.refresh,fg = "white", bg = "red", font = ("arial black",12,"bold"))
        but6.grid(row = 7,column = 0, padx = 10, pady = 15, sticky = "we")
        
        but7 = tk.Button(self, text = "MAIN MENU", command = controller.refresh,fg = "white", bg = "red", font = ("arial black",12,"bold"))
        but7.grid(row = 7,column = 1, padx = 10, pady = 15, sticky = "we")
    ...
    def deletePizza(self):
        self.controller.destroy()
        changes.DeletePizza(self.empid,self.cur).mainloop()
...
class EmployeeDetails(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        but6 = tk.Button(self, text = "HIRE/FIRE/REHIRE EMPLOYEE", command = lambda : controller.show_frame(HireFireRehire), fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but6.grid(row = 4,columnspan = 2, padx = 10, pady = 10, sticky = "we")
...
class ChangeEmployeeDetails(tk.Frame):#CHANEG FOR ADMIN
    ...
    def displayEmployee(self):
            self.controller.destroy()
            changes.ChangeEmployeeByAdmin(self.empid, self.employeeid.get(), self.cur).mainloop()
        
     
class HireFireRehire(tk.Frame):
    
    def __init__(self, empid, cur, parent, controller):
        tk.Frame.__init__(self, parent)
        label = tk.Label(self, text = " HIRE-FIRE-REHIRE \nEMPLOYEE", font = ("Verdana",25, "bold italic underline"), fg = "blue", bg = "white", relief = GROOVE)
        label.grid(row = 0, columnspan = 2, padx = 10, pady = 10)
        self.empid = empid
        self.cur = cur
        self.controller = controller
        ...
        but1 = tk.Button(self, text = "HIRE EMPLOYEE", command = self.hireEmployee, fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but1.grid(row = 1,columnspan = 2, padx = 10, pady = 10,sticky = "we")
        
        but2 = tk.Button(self, text = "FIRE/REHIRE EMPLOYEE", command = self.firerehireEmployee, fg = "white", bg = "#0000cd", font = ("arial black",11, "bold"))
        but2.grid(row = 2,columnspan = 2, padx = 10, pady = 10, sticky = "we")
    ...
    def hireEmployee(self):
        self.controller.destroy()
        creates.CreateEmployee(self.empid, self.cur).mainloop()
        
    def firerehireEmployee(self):
        self.controller.destroy()
        changes.FireRehireEmployee(self.empid, self.cur).mainloop()
...
def startAdmin(empid, cur): 
    Admin(empid,cur).mainloop()       
